...
class Braces_Theme_Customizer {
	...
	function braces_customize_register( $wp_customize ) {
		...
		$wp_customize->add_section( 'braces_color_scheme', array(
		...
		$wp_customize->add_control( 'braces_color_scheme', array(
			'label'      => __('Color Scheme', 'braces' ),
			'section'    => 'braces_color_scheme',
			'settings'   => 'braces_theme_options[color_scheme]',
			'type'       => 'radio',
			'choices'    => array(
					'value1' => 'Choice 1',
					'value2' => 'Choice 2',
